...
{% includes image.html url="/images/hgt.png" description="Horizontal gene transfer (HGT) event between individual A2 to individual B2* across different lineages." %}
